...
<div class="items-center justify-center hidden md:flex">
    ...
    <button class="h-10 px-4 rounded-full hover:bg-gray-100">
        <span class="text-sm font-medium line-clamp-1">
            Airbnb your home
        </span>
    </button>

    <button class="flex items-center justify-center w-10 h-10 mr-1 rounded-full hover:bg-gray-100">
    ...
    <button class="flex items-center justify-center gap-2 p-1 px-2 border border-gray-300 rounded-full hover:shadow-md">
        ...
        <span class="w-8 h-8 text-logoSecondary">
            <svg width="32px"
                    height="32px"
                    class="w-8 h-8"
                    xmlns="http://www.w3.org/2000/svg"
